...
const MANIFESTS_DIR = "https://github.com/nilaypatell/driftcite/tree/main/manifests";
...
const TNUM: CSSProperties = { textAlign: "right", fontFeatureSettings: "'tnum' 1" };
    ...
    <main>
      <Column>
        ...
        <section className="dc-rv" style={{ padding: "56px 0" }}>
          <table className="dc-table" style={{ maxWidth: 880 }}>
            ...
            <tbody>
              {SOURCE_ROWS.map((row) => (
                <tr key={row.label}>
                  <td style={row.bold ? { fontWeight: 600 } : undefined}>{row.label}</td>
                  <td>{row.source}</td>
        ...
        <section style={{ padding: "70px 0" }}>
              ...
              <div key={band.label}>
                <p
                  style={{
                    ...
                    fontFeatureSettings: "'tnum' 1",
                    color:
                      i === BY_POPULARITY.length - 1 ? "var(--color-accent)" : undefined,
                  }}
                >
          ...
          >
            The share rises with popularity. Bigger codebases have more call sites
            and longer memories — drift is not a small-project problem.
          </p>
        </section>
        ...
        <section id="feed" style={{ padding: "70px 0", scrollMarginTop: 96 }}>
          ...
          <div className="dc-rv">
            <p style={{ ...LEAD, marginTop: 20 }}>
              ...
              to a commit produced by a public CI run whose logs anyone can read.
              For a product whose entire pitch is{" "}
              <i>we cite the provider instead of guessing,</i> the pipeline itself
              being auditable is the argument.
            </p>
            <p style={{ ...LEAD, marginTop: 16 }}>
              Every fact is public and free to read, and you can vendor the whole
              ...
              the feed as a competing feed. The scanner itself is Apache-2.0 —
              embed it anywhere, including your own pipelines.
            </p>
          </div>
        </section>
        ...
        {/* ── 03 / 03 · contributing ────────────────────────────────── */}
        <section id="add" style={{ padding: "70px 0 28px", scrollMarginTop: 96 }}>
          <div style={{ marginBottom: 16 }}>
          ...
          >
            ...
            >
              ...
              , not in code. If a provider publishes a versioned OpenAPI spec in a
              public git repository, four lines is the whole integration. The{" "}
              <code className="dc-mono" style={{ fontSize: "0.9em" }}>
                markers
              </code>{" "}
              matter more than they look: they are what stops a retired parameter
            ...
            >
              <span style={{ color: "var(--color-term-label)" }}># providers.yaml</span>
